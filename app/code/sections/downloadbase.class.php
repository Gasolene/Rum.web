<?php // this class will handle any requests to the /download.tpl page
	...
	abstract class DownloadBase extends \PHPRum\SideMenuController
	{
		/**
		...
		final public function onPageInit($sender, $args)
		{
			...
			$this->registerMenuItem('Plugins', 'download/plugins');
			$this->registerMenuItem('Archive', 'download/archive');
		}
	}
?>