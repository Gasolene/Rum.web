<?php
	 ...
	 * @subpackage		Make
	 */
	class JSONWebService extends MakeBase
	{
		/**
		 * Default namespace
		 * @var string
		...
		public function make($target, array $options = array())
		{
			...
			$baseClassName = '\\System\\Web\\Services\\JSONWebServiceBase';
			$pageURI = $target;
			...
			$controllerTemplate = file_get_contents(\System\Base\ApplicationBase::getInstance()->config->root . "/system/make/templates/jsonwebservice.tpl");
