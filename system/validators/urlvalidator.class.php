<?php
	...
	class URLValidator extends PatternValidator
	{
		...
		protected function onLoad()
		{
			...
			{
				$this->errorMessage = $this->errorMessage?$this->errorMessage:"{$this->controlToValidate->label} " . \System\Base\ApplicationBase::getInstance()->translator->get('must_be_a_valid_url', 'must be a valid URL');
			}
		}
	}
?>