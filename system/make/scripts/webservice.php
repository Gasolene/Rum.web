<?php
	 ...
	 * @subpackage		Make
	 */
	class WebService extends MakeBase
	{
		/**
		 * Default namespace
		 * @var string
		...
		public function make($target, array $options = array())
		{
			...
			$baseClassName = '\\System\\Web\\Services\\WebServiceBase';
			$pageURI = $target;
			...
			$controllerTemplate = file_get_contents(\System\Base\ApplicationBase::getInstance()->config->root . "/system/make/templates/webservice.tpl");
